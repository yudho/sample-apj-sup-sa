"""Llama 4 Scout 17B-16E benchmark configuration."""
...
def load_catalog(*, auto_refresh: bool = True, max_age_hours_prices: int = 24,
                 max_age_hours_hardware: int = 24 * 30, offline_ok: bool = True,
                 regions: list[str] | None = None) -> "Catalog":
    from vllm_ec2_bench import Catalog
...
def refresh_catalog(*, regions: list[str] | None = None,
                    regions_extend: list[str] | None = None,
                    hardware: bool = True, prices: bool = True) -> "Catalog":
    from vllm_ec2_bench import Catalog
...
__all__ = [
    ...
    "LLAMA_4_SCOUT_17B", "SEED_INPUT", "SYSTEM_PROMPT",
    "development_experiments", "get", "load_catalog", "refresh_catalog",
]
